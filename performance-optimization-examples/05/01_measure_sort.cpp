// Compare
//
// g++ -O0 -std=c++17 -pthread -I../common 01_measure_sort.cpp ../common/profiler.cpp
// g++ -O2 -std=c++17 -pthread -I../common -fno-inline 01_measure_sort.cpp ../common/profiler.cpp
// g++ -O2 -std=c++17 -pthread -I../common 01_measure_sort.cpp ../common/profiler.cpp
// g++ -O3 -ftracer -std=c++17 -pthread -I../common 01_measure_sort.cpp ../common/profiler.cpp
//
